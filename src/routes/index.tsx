...
function Index() {
  return (
    <div className="min-h-screen bg-canvas font-sans text-ink">
      ...
      <div id="top" className="mx-auto grid max-w-screen-xl grid-cols-1 gap-x-16 gap-y-12 px-8 pt-32 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
        {/* Left intro column */}
        <section className="border-t border-ink/15 pt-8 lg:sticky lg:top-24 lg:self-start">
          ...
          {/* Contact block */}
          <div id="contact" className="mt-16 space-y-3 border-t border-ink/15 pt-8 lg:mt-24">
